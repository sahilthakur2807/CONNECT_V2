    ...
    <div className="space-y-10 pb-10 max-w-7xl mx-auto font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in duration-300">
        ...
        <StatCard
          ...
          value={metrics?.messageVolume || 0}
          icon={<BarChart2 size={20} />}
          trend="Takes"
        />
        <StatCard
          label="Moderations"
          value={metrics?.moderationCount || 0}
          icon={<Shield size={20} />}
          trend="Enforcements"
        />
      </div>
          ...
          >
            <Card className="p-6 rounded-[32px] bg-card border border-border/50 shadow-sm">
              <CardHeader className="p-0 mb-6">
                ...
                <CardDescription>
                  Visual metrics representing platform engagement and moderation
                  activity for this billing cycle.
                </CardDescription>
              </CardHeader>
          ...
          >
            <Card className="p-8 rounded-[32px] bg-card border border-border/50 shadow-sm max-w-2xl">
              <CardHeader className="p-0 mb-6 border-b border-border pb-4">
                ...
                <CardDescription>
                  Configure global parameters. These metrics are simulated
                ...
                <form onSubmit={handleSaveSettings} className="space-y-6">
                  <div className="flex items-center justify-between p-4 bg-muted/30 rounded-2xl border border-border/50">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Locks down the network for maintenance work.
                      </p>
                    </div>
                    <input
                      id="maint-mode"
                  ...
                  <div className="flex items-center justify-between p-4 bg-muted/30 rounded-2xl border border-border/50">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Toggles whether new users can sign up.
                      </p>
                    </div>
                    <input
                      id="reg-mode"
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          default_reputation: parseInt(e.target.value) || 10,
                        })
                      }
                    />
                  </div>
                  ...
                  <Button
                    type="submit"
                    className="w-full h-12 rounded-2xl font-bold uppercase text-xs tracking-widest cursor-pointer shadow-lg shadow-primary/20"
                  >
                    Save Configurations
                  </Button>
                </form>
            ...
            <Card className="p-8 rounded-[32px] bg-card border border-border/50 shadow-sm max-w-2xl">
              <CardHeader className="p-0 mb-6 border-b border-border pb-4">
                <CardTitle className="text-xl font-bold flex items-center gap-2">
                  ...
                  Reputation Point Control
                </CardTitle>
                <CardDescription>
                  Award or penalize reputation points to citizens in the
                  network. Direct database hooks.
                </CardDescription>
              </CardHeader>
              <CardContent className="p-0">
                <form onSubmit={handleAwardReputation} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      value={repAmount}
                      onChange={(e) =>
                        setRepAmount(parseInt(e.target.value) || 0)
                      }
                      required
                    />
                  </div>
