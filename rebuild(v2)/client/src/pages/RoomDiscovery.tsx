      ...
      <div className="relative p-12 bg-foreground dark:bg-card rounded-[40px] text-background dark:text-foreground overflow-hidden border dark:border-border/50 animate-in fade-in duration-500">
        ...
        <div className="relative z-10 space-y-8 max-w-2xl">
          ...
          <div className="relative">
            <Search size={24} className="absolute left-6 top-1/2 -translate-y-1/2 text-[#888880]/30 dark:text-foreground/30 pointer-events-none" />
            <Input 
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 space-y-8 animate-in fade-in duration-300">
          <div className="flex items-center justify-between border-b border-border pb-6">
            ...
            <Button variant="outline" size="sm" className="rounded-xl font-bold border-2 gap-2 h-10 px-6 cursor-pointer">
          ...
          {isLoading ? (
            <div className="py-24 text-center">
              ...
              <p className="mt-4 text-xs font-bold text-muted-foreground uppercase tracking-widest">Searching...</p>
            </div>
