  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      if (user) {
        ...
        window.location.href = `/auth?mode=register&email=${encodeURIComponent(
          email
        )}`;
      } else {
  ...
  return (
    <section ref={ref} className="bg-[#0d0d0d] py-28 overflow-hidden relative">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% 50%, #d42b2b14 0%, transparent 70%)",
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <br />
              <span style={{ color: "#d42b2b", fontStyle: "italic" }}>
            ...
            >
              No algorithms ranking your worth. No quote-tweet dunks. Just
              thousands of minds, all over the world, where someone is asking
