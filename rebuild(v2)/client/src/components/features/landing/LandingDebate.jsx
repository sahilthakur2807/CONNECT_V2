  ...
  return (
    <section ref={ref} className="bg-[#0d0d0d] py-28 overflow-hidden">
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, #f0ede6, transparent)",
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:sticky top-24">
            ...
            >
              One question.
              <br />
              <span style={{ fontStyle: "italic", color: "#d42b2b" }}>
                Many minds.
              </span>
            </motion.h2>
            ...
            >
              On Connect, debate doesn't compress into a single hot take. Every
              thread holds the full spectrum — for, against, and the
            ...
            >
              ...
              >
                {threads.length > 0
                  ? `"${threads[0].room?.title || threads[0].content}"`
