    ...
    fetch('/api/messages/trending')
      ...
      .then((data: any[]) => {
        if (Array.isArray(data)) {
          setTickerItems(data.map((msg: any) => `"${msg.content}" · ${msg.reactions?.length || 0} voices`));
          if (data.length > 0) {
  ...
  return (
    <section className="relative min-h-screen bg-[#0d0d0d] flex flex-col overflow-hidden">
      ...
      <motion.div
        ...
        style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", color: "#888880", letterSpacing: "0.12em" }}
      >
        <span className="w-1.5 h-1.5 rounded-full bg-[#d42b2b] animate-pulse" />
        23,101 CONVERSATIONS · LIVE NOW
      </motion.div>
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full px-6 pt-32 pb-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          >
            <h1
              ...
              style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(64px, 10vw, 137.5px)", fontWeight: 900 }}
            >
              Talk.<br />
              <span style={{ fontStyle: "italic", color: "#d42b2b" }}>Debate.</span><br />
              Discover.
            </h1>
          </motion.div>
          ...
          >
            ...
            meaningful conversations spanning across thousands of topics —
            a living network where ideas connect, branch, and evolve.
          </motion.p>
          ...
          >
            <Link
              ...
              style={{ fontFamily: "'Hedvig Letters Serif', serif", fontSize: "15px", letterSpacing: "0.06em", borderRadius: "2px" }}
            >
            ...
            <Link
              ...
              style={{ fontFamily: "'Hedvig Letters Serif', serif", fontSize: "15px", letterSpacing: "0.06em" }}
            >
            ...
            {[
              ...
              <div key={s.label}>
                <div
                  ...
                  style={{ fontFamily: "'Playfair Display', serif", fontSize: "40px", fontWeight: 700, lineHeight: 1 }}
                >
                  {s.value}
                </div>
                <div
                  className="text-[#555550] mt-1"
                  style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "12.5px", letterSpacing: "0.14em" }}
                >
                  {s.label}
                </div>
              </div>
        ...
        >
          ...
          <div
            ...
            style={{ background: "radial-gradient(ellipse at center, #d42b2b 0%, transparent 70%)", filter: "blur(60px)" }}
          />

          <div className="relative bg-[#161616] border border-white/10 p-6" style={{ borderRadius: "4px" }}>
            <div className="flex items-center justify-between mb-4">
              ...
              <span
                ...
                style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "12.5px", letterSpacing: "0.1em" }}
              >
                OUR QUESTION
              </span>
            </div>
            ...
            <p
              ...
              style={{ fontFamily: "'Playfair Display', serif", fontSize: "22.5px", fontStyle: "italic", fontWeight: 400 }}
            >
            ...
            <div className="space-y-2.5 mb-6">
              {liveReplies.map((r, i) => {
                ...
                return (
                  ...
                  >
                    <div className="flex-1 relative h-8 bg-[#0d0d0d] border border-white/[0.07] overflow-hidden" style={{ borderRadius: "2px" }}>
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: `${pct}%` }}
                        transition={{ delay: 1.1 + i * 0.1, duration: 0.8, ease: "easeOut" }}
                        className="absolute inset-y-0 left-0"
                        style={{ background: i === 0 ? "#d42b2b22" : "#ffffff08" }}
                      />
                      <span
                        className="absolute inset-0 flex items-center px-3 truncate"
                        style={{ fontFamily: "'Hedvig Letters Serif', serif", fontSize: "15px", color: i === 0 ? "#f0ede6" : "#FFFFFF" }}
                      >
                        {r.content}
                      </span>
                    </div>
            ...
            <div className="flex items-center gap-3">
              {["#E06C75", "#61AFEF", "#98C379", "#E5C07B"].map((c, i) => (
                <div
                  ...
                  style={{ background: c, fontFamily: "'JetBrains Mono', monospace" }}
                >
                  {["K", "A", "J", "M"][i]}
                </div>
              ))}
          ...
          >
            <div
              ...
              style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", letterSpacing: "0.12em" }}
            >
              BRANCHING NOW
            </div>
            <p
              className="text-[#f0ede6]"
              style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", lineHeight: 1.5 }}
            >
      ...
      <div className="border-t border-white/10 bg-[#0a0a0a] py-3 overflow-hidden">
        ...
        >
          {[...(tickerItems.length ? tickerItems : ['Join the conversation']), ...(tickerItems.length ? tickerItems : ['Join the conversation'])].map((item, i) => (
            <span
              key={i}
              className="text-[#444440] flex-shrink-0"
              style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "13.75px", letterSpacing: "0.04em" }}
            >
